...
package object mapper {
  ...
  class JsonApiViewReader(protected val viewReader: ViewReader,
                          protected val jsonReader: String => RootObject) {
  ...
  class JsonApiViewWriter(protected val viewWriter: ViewWriter,
                          protected val jsonMapper: RootObject => String) {
